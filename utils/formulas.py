...
def hit_chance(attacker, defender, move, weather='none'):
    ...
    """
    # Block 22: the thrower's own sky. What that reaches here is the weather-gated
    # evasion abilities - a Sand Veil is not hiding anybody from a specimen whose move
    # reads the sky as cloudless, exactly as it would not under a real sun.
    #
    # It does NOT reach Thunder or Hurricane, because this engine has no weather-gated
    # accuracy for either: their 70 is flat in every sky. That is a gap in the MOVE
    # layer rather than anything to do with this ability, and it is left alone here.
